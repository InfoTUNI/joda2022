...
* (Todoistissa)
* Sentdex on Python 3 basics: https://pythonprogramming.net/introduction-learn-python-3-tutorials/
* Introduction to Computer Science and Programming in Python, Fall 2016,
Instructor: Dr. Ana Bell, https://www.youtube.com/watch?v=nykOeWgQcHM
* Akin menetelmäblogi: https://tilastoapu.wordpress.com/

## analytiikkaympäristöjä:

* Google Colab

## Demoideoita

* Vaikuttaa siltä, että asuntojen hinnat eivät ole sitä miltä ne vaikuttavat (vrt. Tsekki)
*
